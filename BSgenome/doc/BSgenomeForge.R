...
###################################################
### code chunk number 2: BSgenomeForge.Rnw:425-436
###################################################
library(BSgenome)
...
###################################################
### code chunk number 3: BSgenomeForge.Rnw:449-451 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 4: BSgenomeForge.Rnw:674-679
###################################################
library(BSgenome)
seed_files <- system.file("extdata", "GentlemanLab", package="BSgenome")
...
###################################################
### code chunk number 5: BSgenomeForge.Rnw:694-696 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 6: BSgenomeForge.Rnw:738-739
###################################################
sessionInfo()
