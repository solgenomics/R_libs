...
The data frame has two factors with `r nla` and `r nlb` levels. The experimental design is a randomized complete block design with `r nrep` blocks. The statistical model is
$$
