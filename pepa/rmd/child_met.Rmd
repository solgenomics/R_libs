...
`r if (at[4, 5] < 0.05 | (at[1, 5] < 0.05 & at[2, 5] < 0.05)) {paste0("### ", {{i+1}}, ".2.5. LSD test for environments")}`
...
`r if (at[4, 5] < 0.05 | (at[1, 5] < 0.05 & at[2, 5] < 0.05)) {paste0("### ", {{i+1}}, ".2.6. Tukey test for environments")}`
