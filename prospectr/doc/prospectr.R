...
## ----movin, fig.cap = "Effect of a moving average with window size of 11 bands on a raw spectrum", tidy = TRUE, fig.height = 6, fig.width = 10, dpi = 50, out.height = "60%", out.width = "100%"----
# add some noise
...
## ----d1,fig.cap="Effect of first derivative and second derivative", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%"----
# X = wavelength
# Y = spectral matrix
# n = order
...
## ----gapder,fig.cap="Effect of 1st-order gap derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%"----
# first derivative with a gap of 10 bands
gd1 <- t(diff(t(NIRsoil$spc), differences = 1, lag = 10)) 

## ----gapseg,fig.cap="Effect of 1st-order gap-segment derivative ", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%"----
...
## ----snv, eval=TRUE, fig.cap="Effect of SNV on raw spectra", fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%"----
snv <- standardNormalVariate(X = NIRsoil$spc)

## ----detrend, fig.cap="Effect of SNV-Detrend on raw spectra",fig.height=6,fig.width=10, tidy=TRUE, dpi = 50,out.height="60%",out.width="100%"----
...
## ----cr, fig.cap = "Absorbance and continuum-removed absorbance spectra", fig.height = 6, fig.width = 10, tidy = TRUE, dpi = 50, out.height = "60%", out.width = "100%"----
...
## ----naes, fig.cap = "Selection of 5 samples by k-means sampling", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
# X = the input matrix
...
## ----ken, fig.cap="Selection of 40 calibration samples with the Kennard-Stone algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
...
## ----ken2, fig.cap="Kennard-Stone sampling on the NIRsoil dataset", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
...
## ----duplex, fig.cap="Selection of 15 calibration and validation samples with the DUPLEX algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
...
## ----shenk, fig.cap="Selection of samples with the SELECT algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
...
## ----puchwein, fig.cap="Samples selected by the Puchwein algorithm", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
...
## ----puchwein2, fig.cap="How to find the optimal loop", tidy=TRUE, dpi = 50, eval = FALSE----
#  par(mfrow = c(2, 1))
...
## ----honigs, fig.cap="Spectra selected with the Honigs algorithm and bands used", tidy = TRUE, dpi = 50, fig.height = 5, fig.width = 5, out.height = '80%', out.width = '80%', fig.align ='center'----
