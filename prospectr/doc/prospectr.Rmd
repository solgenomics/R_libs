...
In addition, [Bryan Hanson](https://github.com/bryanhanson?tab=followers) 
...
Here is an exemple of the use of the `gapDer` function.
...
of the continuum (or envelope) of a given spectrum. The continuum-removed 
spectrum of a given spectrum is computed as follows:
...
$\phi_{i} = \frac{x_{i}}{c_{i}};  i=\left \{ 1,..., p\right\}$, where $x_{i}$ 
and $c_{i}$ are the original and the continuum reflectance (or absorbance) 
