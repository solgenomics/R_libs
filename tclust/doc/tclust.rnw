...
\begin{figure}[t!]
\centering
%\includegraphics[width = 0.65 \textwidth]{Plots_R-chunk1}
<<fig=TRUE,echo=false,results=hide,label=chunk1,width=7.14,height=7.8>>=
...
Among the methods considered, \code{tclust} also implements a
...
criterion and it goes back to \cite{FriR67}. The trimmed version of
...
<<fig=TRUE,echo=false,results=hide,label=chunk10,width=10,height=5.45>>=
#################
##  Figure 10  ##
#################
...
<<fig=TRUE,echo=false,results=hide,label=chunk11,width=9,height=6.5>>=
...
<<fig=TRUE,echo=false,results=hide,label=chunk14,width=9,height=6.5>>=
...
are plotted. The 7 most doubtful decisions are rounded by a circle symbol.} \label{fig4:f8}
\end{figure}
